...
export const catalogData: Category[] = [
  {
    id: "halawiyat",
    title: "حلويات",
    description: "تشكيلة واسعة من الحلويات اللذيذة المحضرة يومياً بأجود المكونات",
    products: [
      {
        id: "h1",
        name: "محاشي",
  ...
  },
  {
    id: "gluten-free",
    title: "خالي الجلوتين",
    description: "منتجات مخصصة لأصحاب الحساسية تجاه الجلوتين",
    products: [],
  },
  {
    id: "taheen",
  ...
  },
  {
    id: "maajinaat",
    title: "معجنات",
    description: "معجنات ومخبوزات على أصولها",
    products: [],
  },
  {
    id: "sugar-free",
