...
export const catalogData: Category[] = [
  ...
  { id: "baqasim-cake",   title: "بقاصم وكعك",     emoji: "🎂", image: "/images/categories/baqasim-cake.png",  description: "تشكيلة من البقاصم والكعك الطازج",           products: [] },
  ...
  { id: "products-other", title: "منتجات",         emoji: "🛒", image: "/images/categories/products-other.png", description: "منتجات متنوعة مختارة بعناية",               products: [] },
  ...
  { id: "sugar-free",     title: "خالي السكر",     emoji: "💚", image: "/images/categories/sugar-free.png",  description: "منتجات لذيذة خاصة بمرضى السكري",            products: [] },
